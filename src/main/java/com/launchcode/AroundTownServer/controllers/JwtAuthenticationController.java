...
//
    ...
    private void authenticate(String username, String pwhash) throws Exception {
        try {
            authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(username, pwhash));
